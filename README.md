...
* **MessageInsight** *(إضافة حصرية من LOSTSTR)*
...
* **MessageBookmarks** *(إضافة حصرية من LOSTSTR)*
  * *الإشارات المرجعية الخاصة:* احفظ أي رسالة كإشارة مرجعية خاصة بك (بخلاف Pin التي تظهر للجميع)، وصنّفها إلى عام أو مهم أو لاحقاً، وابحث فيها، وانتقل إليها بنقرة واحدة — كل شيء محفوظ محلياً ولا يراه أحد سواك.
