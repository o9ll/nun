...
/**
 * `Webpack` is a utility class for getting internal webpack modules. Instance is accessible through the {@link NuApi}.
...
const Webpack = {
    ...
    getWithKey(filter: ExportedOnlyFilter, options: WithKeyOptions = {}) {
        if (("first" in options)) return Logger.error("NuApi.Webpack~getWithKey", "Unsupported option first.");
        if (("defaultExport" in options) && typeof (options.defaultExport) !== "boolean") return Logger.error("NuApi.Webpack~getWithKey", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
        if (("searchExports" in options) && typeof (options.searchExports) !== "boolean") return Logger.error("NuApi.Webpack~getWithKey", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
        if (("raw" in options) && typeof (options.raw) !== "boolean") return Logger.error("NuApi.Webpack~getWithKey", "Invalid type for options.raw", options.raw, "Expected: boolean");
        return getWithKey(filter, options);
    },

    getModule<T extends any>(filter: ModuleFilter, options: WebpackOptions = {}) {
        if (("first" in options) && typeof (options.first) !== "boolean") return Logger.error("NuApi.Webpack~get", "Invalid type for options.first", options.first, "Expected: boolean");
        if (("defaultExport" in options) && typeof (options.defaultExport) !== "boolean") return Logger.error("NuApi.Webpack~getModule", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
        if (("searchExports" in options) && typeof (options.searchExports) !== "boolean") return Logger.error("NuApi.Webpack~getModule", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
        if (("raw" in options) && typeof (options.raw) !== "boolean") return Logger.error("NuApi.Webpack~getModule", "Invalid type for options.raw", options.raw, "Expected: boolean");
    ...
    getModules<T extends any[]>(filter: ModuleFilter, options: WebpackOptions = {}) {
        if (("defaultExport" in options) && typeof (options.defaultExport) !== "boolean") return Logger.error("NuApi.Webpack~getModules", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
        if (("searchExports" in options) && typeof (options.searchExports) !== "boolean") return Logger.error("NuApi.Webpack~getModules", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
        if (("raw" in options) && typeof (options.raw) !== "boolean") return Logger.error("NuApi.Webpack~getModules", "Invalid type for options.raw", options.raw, "Expected: boolean");
    ...
    waitForModule<T>(filter: ModuleFilter, options: LazyOptions = {}) {
        if (("defaultExport" in options) && typeof (options.defaultExport) !== "boolean") return Logger.error("NuApi.Webpack~waitForModule", "Invalid type for options.defaultExport", options.defaultExport, "Expected: boolean");
        if (("signal" in options) && !(options.signal instanceof AbortSignal)) return Logger.error("NuApi.Webpack~waitForModule", "Invalid type for options.signal", options.signal, "AbortSignal expected.");
        if (("searchExports" in options) && typeof (options.searchExports) !== "boolean") return Logger.error("NuApi.Webpack~waitForModule", "Invalid type for options.searchExports", options.searchExports, "Expected: boolean");
        if (("raw" in options) && typeof (options.raw) !== "boolean") return Logger.error("NuApi.Webpack~waitForModule", "Invalid type for options.raw", options.raw, "Expected: boolean");
    ...
    getMangled<T extends object>(filter: ModuleFilter | string | RegExp, mangled: Record<keyof T, ExportedOnlyFilter>, options: Options = {}) {
        ...
        if (typeof (defaultExport) !== "boolean") return Logger.error("NuApi.Webpack~getMangled", "Invalid type for options.defaultExport", defaultExport, "Expected: boolean");
        if (typeof (searchExports) !== "boolean") return Logger.error("NuApi.Webpack~getMangled", "Invalid type for options.searchExports", searchExports, "Expected: boolean");
        if (typeof (raw) !== "boolean") return Logger.error("NuApi.Webpack~getMangled", "Invalid type for options.raw", raw, "Expected: boolean");
    ...
    getById(id: PropertyKey, options: WebpackOptions = {}) {
        if (("raw" in options) && typeof (options.raw) !== "boolean") return Logger.error("NuApi.Webpack~getById", "Invalid type for options.raw", options.raw, "Expected: boolean");
        if (("fatal" in options) && typeof (options.fatal) !== "boolean") return Logger.error("NuApi.Webpack~getById", "Invalid type for options.fatal", options.fatal, "Expected: boolean");
