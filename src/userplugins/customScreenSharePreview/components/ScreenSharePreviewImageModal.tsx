...
export function ScreenSharePreviewImageModal({ modalProps, close }: { modalProps: RenderModalProps; close: () => void; }) {
    ...
    return (
        <ModalRoot {...modalProps} size={ModalSize.SMALL}>
            ...
            <ModalContent>
                <Forms.FormText>
                    {"Choose an image to use as your screen share preview."}
                </Forms.FormText>
