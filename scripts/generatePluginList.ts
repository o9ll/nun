...
import { getEntryPoint, isPluginFile, parseDevs, parseNunDevs, parseEquicordDevs, parseFile, PluginData } from "./utils";
...
(async () => {
    ...
    if (nunFlag) {
        ...
        dirs = ["src/plugins", "src/plugins/_core", "src/equicordplugins/_core", "src/equicordplugins", "src/nunplugins/_core", "src/nunplugins"];
    }
