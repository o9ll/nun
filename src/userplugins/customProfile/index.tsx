...
const BADGES = [
    ...
    { label: ("Partenaire"), flag: FLAG.PARTNER, icon: "https://cdn.discordapp.com/badge-icons/3f9748e53446a137a052f3454e2de41e.png" },
...
const NITRO_LEVELS = [
    { label: ("Nitro (0 mois)"), icon: "https://cdn.discordapp.com/badge-icons/2ba85e8026a8614b640c2837bcdfe21b.png" },
    { label: ("Bronze (1 mois)"), icon: "https://cdn.discordapp.com/badge-icons/4f33c4a9c64ce221936bd256c356f91f.png" },
    { label: ("Argent (2 mois)"), icon: "https://cdn.discordapp.com/badge-icons/4514fab914bdbfb4ad2fa23df76121a6.png" },
    { label: ("Or (3 mois)"), icon: "https://cdn.discordapp.com/badge-icons/2895086c18d5531d499862e41d1155a6.png" },
    { label: ("Platine (6 mois)"), icon: "https://cdn.discordapp.com/badge-icons/0334688279c8359120922938dcb1d6f8.png" },
    { label: ("Diamant (12 mois)"), icon: "https://cdn.discordapp.com/badge-icons/0d61871f72bb9a33a7ae568c1fb4f20a.png" },
    { label: ("Émeraude (24 mois)"), icon: "https://cdn.discordapp.com/badge-icons/11e2d339068b55d3a506cff34d3780f3.png" },
    { label: ("Rubis (36 mois)"), icon: "https://cdn.discordapp.com/badge-icons/cd5e2cfd9d7f27a8cdcd3e8a8d5dc9f4.png" },
    { label: ("Opale (72 mois)"), icon: "https://cdn.discordapp.com/badge-icons/5b154df19c53dce2af92c9b61e6be5e2.png" },
];
...
const BOOST_LABELS = BOOST_LABELS_RAW.map(l => (l));
    ...
    return (
        <div className="cp-field">
            ...
            <div className="cp-image-row">
                <input className="cp-input cp-url-input" placeholder={("Image URL...")} value={value.startsWith("data:") ? "" : value} onChange={e => onChange(e.target.value)} />
                ...
                {value && <>
                    ...
                    <button className="cp-clear-btn" onClick={() => onChange("")} title={("Delete")}><CloseIcon /></button>
                </>}
            </div>
        </div>
    );
    ...
    return (
        <div className="cp-field">
            ...
            <div className="cp-badges">
                ...
                <BadgeBtn label={("Orbs — Apprentice")}
            ...
            {hasOldName && (
                <div className="cp-field" style={{ marginTop: 6 }}>
                    ...
                    <div style={{ fontSize: 11, color: "var(--text-muted)", marginTop: 3 }}>
                        {('Ex : Triggerr#5954 — will appear as "Old username: Triggerr#5954" when hovering the badge.')}
                    </div>
                </div>
            )}
            <SectionLabel style={{ marginTop: 8 }}>{("Boost Badge (Server Booster)")}</SectionLabel>
            <div className="cp-badges">
    ...
    return (
        <ModalRoot {...rootProps} size="medium">
            ...
            <ModalContent className="cp-content">
                ...
                <div className="cp-field">
                    <SectionLabel>{("Profile color (Nitro — gradient possible)")}</SectionLabel>
                ...
                <Field label={("Email address (local display)")} value={data.email ?? ""} placeholder="exemple@mail.com" onChange={v => set("email", v)} />
                <Field label={("Phone (local display)")} value={data.phone ?? ""} placeholder="+33 6 00 00 00 00" onChange={v => set("phone", v)} />
                <div className="cp-divider" />
                <BadgePicker
...
export default definePlugin({
    ...
    toolboxActions: {
        [("Open Custom Profile")]() { openModal(props => <CustomProfileModal rootProps={props} />); },
    },
    ...
    userProfileBadges: [
        {
            getBadges({ userId, badges: nativeBadges }: { userId: string; guildId: string; badges: ProfileBadge[]; }) {
                ...
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.STAFF)) {
                    badgeList.push({ description: ("Staff Discord"), iconSrc: "https://cdn.discordapp.com/badge-icons/5e74e9b61934fc1f67c65515d1f7e60d.png", position: 0, props: { style } });
                }

                // 2. Partner
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.PARTNER)) {
                    badgeList.push({ description: ("Partenaire"), iconSrc: "https://cdn.discordapp.com/badge-icons/3f9748e53446a137a052f3454e2de41e.png", position: 0, props: { style } });
                }
                ...
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.HYPESQUAD)) {
                    badgeList.push({ description: ("HypeSquad Events"), iconSrc: "https://cdn.discordapp.com/badge-icons/bf01d1073931f921909045f3a39fd264.png", position: 0, props: { style } });
                }

                // 5. Bug Hunter 2
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.BUG_HUNTER_2)) {
                    badgeList.push({ description: ("Bug Hunter Lvl 2"), iconSrc: "https://cdn.discordapp.com/badge-icons/848f79194d4be5ff5f81505cbd0ce1e6.png", position: 0, props: { style } });
                }

                // 6. House Badges (HypeSquad Houses)
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.BALANCE)) {
                    badgeList.push({ description: ("HypeSquad Balance"), iconSrc: "https://cdn.discordapp.com/badge-icons/3aa41de486fa12454c3761e8e223442e.png", position: 0, props: { style } });
                }
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.BRAVERY)) {
                    badgeList.push({ description: ("HypeSquad Bravery"), iconSrc: "https://cdn.discordapp.com/badge-icons/8a88d63823d8a71cd5e390baa45efa02.png", position: 0, props: { style } });
                }
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.BRILLIANCE)) {
                    badgeList.push({ description: ("HypeSquad Brilliance"), iconSrc: "https://cdn.discordapp.com/badge-icons/011940fd013da3f7fb926e4a1cd2e618.png", position: 0, props: { style } });
                }

                // 7. Bug Hunter 1
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.BUG_HUNTER_1)) {
                    badgeList.push({ description: ("Bug Hunter Lvl 1"), iconSrc: "https://cdn.discordapp.com/badge-icons/2717692c7dca7289b35297368a940dd0.png", position: 0, props: { style } });
                }

                // 8. Developer (Verified)
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.DEV_VERIFIED)) {
                    badgeList.push({ description: ("Verified Developer"), iconSrc: "https://cdn.discordapp.com/badge-icons/6df5892e0f35b051f8b61eace34f4967.png", position: 0, props: { style } });
                }

                // 9. Former Moderator
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.MOD_ALUMNI)) {
                    badgeList.push({ description: ("Former Moderator"), iconSrc: "https://cdn.discordapp.com/badge-icons/fee1624003e2fee35cb398e125dc479b.png", position: 0, props: { style } });
                }

                // 10. Early Supporter
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.EARLY_SUPPORTER)) {
                    badgeList.push({ description: ("Early Supporter"), iconSrc: "https://cdn.discordapp.com/badge-icons/7060786766c9c840eb3019e725d2b358.png", position: 0, props: { style } });
                }
                ...
                if (storedData.badgeFlags && (storedData.badgeFlags & FLAG.ACTIVE_DEVELOPER)) {
                    badgeList.push({ description: ("Active Developer"), iconSrc: "https://cdn.discordapp.com/badge-icons/6bdc42827a38498929a4920da12695d9.png", position: 0, props: { style } });
                }
