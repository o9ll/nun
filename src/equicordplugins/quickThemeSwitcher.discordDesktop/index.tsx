...
const settings = definePluginSettings({
    ...
    includeOnline: {
        type: OptionType.BOOLEAN,
        description: "تضمين الثيمات الإلكترونية",
        default: true,
        onChange: refreshThemeList,
    },
    sortOrder: {
    ...
    showNotifications: {
        type: OptionType.BOOLEAN,
        description: "إظهار الإشعارات عند إضافة أو إزالة الثيمات",
        default: true,
    },
});
...
export default definePlugin({
    ...
    description: "التبديل السريع بين الثيمات باستخدام اختصارات لوحة المفاتيح.",
