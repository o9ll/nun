...
function EaBadgeIcon({ size }: { size: number }): JSX.Element {
    return (
        ...
        >
            <defs>
                <pattern id="eq-arabic-icon-pat" patternUnits="userSpaceOnUse" width="24" height="24">
                    <image href={PROJECT_ICON} x="2" y="2" width="20" height="20" />
                </pattern>
            </defs>
            <circle cx="12" cy="12" r="12" fill="#f59e0b" />
            <circle cx="12" cy="12" r="10" fill="url(#eq-arabic-icon-pat)" />
        </svg>
    );
}
