...
export interface MicrophoneSettingsModalProps extends SettingsModalProps {
...
export const MicrophoneSettingsModal = (props: MicrophoneSettingsModalProps) => {
    const { microphoneStore, showInfo, ...settingsModalProps } = props;
    ...
    const settingsCardVoiceBitrate =
        <SettingsModalCard
            ...
            <SettingsModalCardItem title={"kbps"}>
    ...
    return (
        <SettingsModal
            ...
            {...settingsModalProps}
            onDone={() => {
                settingsModalProps.onClose();
                settingsModalProps.onDone?.();
            }}
        >
            {simpleMode
