...
import { ScreenshareProfile, ScreenshareStore } from "@userplugins/betterScreenshare.desktop/stores";
import { ProfilableStore, replaceObjectValuesIfExist, types, utils } from "@userplugins/philsPluginLibrary";
