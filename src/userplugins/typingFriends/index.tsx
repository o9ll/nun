...
const settings = definePluginSettings({
    ...
    typingTimeout: {
        ...
        default: 9000,
        description: "Time in milliseconds before typing indicator clears.",
    },
    iconHorizontalOffset: {
        type: OptionType.NUMBER,
        default: 0,
        description: "Horizontal offset in pixels for typing indicators next to server icons.",
    },
});
...
export default definePlugin({
    ...
    authors: [{ name: "Xylen", id: 0n }, { name: "Streets", id: 463495065407586304n }],
    settings,
