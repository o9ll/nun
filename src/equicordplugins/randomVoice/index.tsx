...
const settings = definePluginSettings({
    ...
    spacesLeftOperation: {
        description: "اختر عملية للحد الأقصى من المستخدمين",
        type: OptionType.SELECT,
        options: [...operationOptions],
        default: "<",
    },
    spacesLeft: {
        description: "اختر الحد الأقصى للمستخدمين",
        type: OptionType.SLIDER,
        markers: makeRange(0, 15, 1),
        default: 3,
        stickToMarkers: true,
    ...
    vcLimit: {
        description: "اختر حد القناة الصوتية",
        type: OptionType.SLIDER,
    ...
    Servers: {
        description: "السيرفرات المُدرجة",
        type: OptionType.STRING,
        default: "",
    },
    autoNavigate: {
        type: OptionType.BOOLEAN,
        description: "ينتقل تلقائياً إلى القناة الصوتية.",
        default: false,
    },
    autoCamera: {
        type: OptionType.BOOLEAN,
        description: "يشغّل الكاميرا تلقائياً",
        default: false,
    },
    autoStream: {
        type: OptionType.BOOLEAN,
        description: "يشغّل البث تلقائياً",
        default: false,
    },
    selfMute: {
        type: OptionType.BOOLEAN,
        description: "يكتم ميكروفونك تلقائياً عند الانضمام للقناة الصوتية.",
        default: false,
    },
    selfDeafen: {
        type: OptionType.BOOLEAN,
        description: "يصمّ صوتك تلقائياً عند الانضمام للقناة الصوتية.",
        default: false,
    },
    leaveEmpty: {
        type: OptionType.BOOLEAN,
        description: "يبحث عن مكالمة عشوائية عندما تكون قناتك الصوتية فارغة.",
        default: false,
    },
    prioritizeFriends: {
        type: OptionType.BOOLEAN,
        description: "يُفضّل القنوات التي يتواجد فيها أصدقاؤك كلما أمكن.",
        default: false,
    },
    avoidStages: {
        type: OptionType.BOOLEAN,
        description: "يتجنّب الانضمام لقنوات المسرح الصوتية.",
        default: false,
    },
    avoidAfk: {
        type: OptionType.BOOLEAN,
        description: "يتجنّب الانضمام لقنوات AFK.",
        default: false,
    },
    video: {
        type: OptionType.BOOLEAN,
        description: "يبحث عن مستخدمين مفتوحة كاميراتهم",
        default: false,
    },
    stream: {
        type: OptionType.BOOLEAN,
        description: "يبحث عن مستخدمين يقومون بالبث",
        default: false,
    },
    mute: {
        type: OptionType.BOOLEAN,
        description: "يبحث عن مستخدمين مكتومين",
        default: false,
    },
    deafen: {
        type: OptionType.BOOLEAN,
        description: "يبحث عن مستخدمين مصمومين",
        default: false,
    },
    includeStates: {
        type: OptionType.BOOLEAN,
        description: "خيار لتضمين الحالات",
        default: false,
    },
    avoidStates: {
        type: OptionType.BOOLEAN,
        description: "خيار لتجنّب الحالات",
        default: false,
    },
});
...
export default definePlugin({
    name: "RandomVoice",
    description: "يضيف زراً بجوار الكتم للانضمام إلى قناة صوتية عشوائية.",
