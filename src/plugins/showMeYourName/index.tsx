...
const settings = definePluginSettings({
    ...
    replies: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض تنسيق الاسم المخصص في الردود.",
    },
    mentions: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض تنسيق الاسم المخصص في الإشارات.",
    },
    typingIndicator: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض أول اسم متاح في تنسيق الاسم المخصص في مؤشر الكتابة.",
    },
    memberList: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض أول اسم متاح في قائمة الأعضاء والرسائل المباشرة وقائمة الأصدقاء.",
    },
    profilePopout: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض أول اسم متاح في النوافذ المنبثقة للملفات الشخصية.",
    },
    voiceChannels: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض أول اسم متاح في قنوات الصوت.",
    },
    reactions: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اعرض أول اسم متاح في تلميحات التفاعلات والاسم الكامل في نوافذها المنبثقة.",
    },
    discriminators: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "أضف رموز التمييز لأسماء البوتات. رموز التمييز أُهملت للمستخدمين لكنها لا تزال مستخدمة للبوتات لجعل أسمائها فريدة.",
    },
    hideDefaultAtSign: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "أخفِ رمز \"@\" الافتراضي قبل الاسم في الإشارات والردود. يُطبق فقط إن كانت الميزة مفعّلة.",
    },
    truncateAllNamesWithStreamerMode: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اختصر جميع الأسماء لا الأسماء فقط في وضع Streamer Mode.",
    },
    removeDuplicates: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "إذا تطابقت أي أسماء، أزل المكررات واعرض الأسماء الفريدة فقط.",
    },
    ignoreFonts: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "استخدم خطوط Discord الافتراضية للأسماء غير الرئيسية بغض النظر عن خط النيترو المخصص.",
    },
    ignoreGradients: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "للأسماء غير الرئيسية، إذا كانت الرتبة تدرجية والإعداد \"Role+-#\"، استخدم اللون الأساسي بدلاً من التدرج، وتجاهل تأثيرات النيترو كلياً."
    },
    animateGradients: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "للأسماء غير الرئيسية، إذا كانت الرتبة تدرجية أو لها تأثير نيترو، حرّكها. يُعطّل بـ \"تجاهل التدرجات\" أو تقليل الحركة.",
    },
    nameSeparator: {
        type: OptionType.STRING,
        description: "الفاصل بين الأسماء. الافتراضي مسافة واحدة.",
        default: " ",
    },
    friendNameOnlyInDirectMessages: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "اعرض أسماء الأصدقاء في الرسائل المباشرة فقط، ليس في السيرفرات.",
    },
    customNameOnlyInDirectMessages: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "اعرض الأسماء المخصصة في الرسائل المباشرة فقط، ليس في السيرفرات.",
    },
    alwaysShowEffects: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "اعرض التأثيرات دائماً كأنك تمرر المؤشر فوق الاسم.",
    },
    includedNames: {
        type: OptionType.STRING,
        description: "ترتيب عرض أسماء المستخدمين والأسماء المعروضة والألقاب وأسماء الأصدقاء والمخصصة. استخدم: {user}، {display}، {nick}، {friend}، {custom}. يمكنك تحديد خيارات احتياطية بالفصل بفواصل: {custom, friend, nick}. بحد أقصى 3 بادئات و3 لواحق لكل اسم.",
        default: "{custom, friend, nick} [{display}] (@{user})",
        isValid: validTemplate,
    },
    customNameColor: {
        type: OptionType.STRING,
        description: "لون الاسم المخصص إذا لم يكن الأول. يقبل أي قيمة CSS صحيحة. استخدم \"Role\" لمتابعة لون رتبة المستخدم أو تأثيرات النيترو أو IRCColors. استخدم \"Role+-#\" لضبط السطوع (مثال: \"Role+15\")",
        default: "Role-25",
        isValid: validColor,
    },
    friendNameColor: {
        type: OptionType.STRING,
        description: "لون اسم الصديق إذا لم يكن الأول. يقبل أي قيمة CSS صحيحة. استخدم \"Role\" لمتابعة لون الرتبة أو النيترو أو IRCColors. استخدم \"Role+-#\" لضبط السطوع.",
        default: "Role-25",
        isValid: validColor,
    },
    nicknameColor: {
        type: OptionType.STRING,
        description: "لون اللقب إذا لم يكن الأول. يقبل أي قيمة CSS صحيحة. استخدم \"Role\" لمتابعة لون الرتبة أو النيترو أو IRCColors. استخدم \"Role+-#\" لضبط السطوع.",
        default: "Role-25",
        isValid: validColor,
    },
    displayNameColor: {
        type: OptionType.STRING,
        description: "لون الاسم المعروض إذا لم يكن الأول. يقبل أي قيمة CSS صحيحة. استخدم \"Role\" لمتابعة لون الرتبة أو النيترو أو IRCColors. استخدم \"Role+-#\" لضبط السطوع.",
        default: "Role-25",
        isValid: validColor,
    },
    usernameColor: {
        type: OptionType.STRING,
        description: "لون اسم المستخدم إذا لم يكن الأول. يقبل أي قيمة CSS صحيحة. استخدم \"Role\" لمتابعة لون الرتبة أو النيترو أو IRCColors. استخدم \"Role+-#\" لضبط السطوع.",
        default: "Role-25",
        isValid: validColor,
    },
    triggerNameRerender: {
        type: OptionType.BOOLEAN,
        description: "أعد رسم الأسماء بتبديل هذا الإعداد.",
        default: false,
        hidden: true
    },
});
...
export default definePlugin({
    name: "ShowMeYourName",
    description: "يعرض أي تركيبة من الأسماء المخصصة وأسماء الأصدقاء والسيرفر والأسماء المعروضة وأسماء المستخدمين في المحادثة.",
