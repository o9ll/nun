...
const settings = definePluginSettings({
    messages: {
        ...
        default: true,
        description: "اعرض تنسيق الاسم المخصص في الرسائل.",
    },
    replies: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض تنسيق الاسم المخصص في الردود.",
    },
    mentions: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض تنسيق الاسم المخصص في الإشارات.",
    },
    typingIndicator: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض أول اسم متاح في تنسيق الاسم المخصص في مؤشر الكتابة.",
    },
    memberList: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض أول اسم متاح في تنسيق الاسم المخصص في قائمة الأعضاء وقائمة الرسائل المباشرة وقائمة الأصدقاء.",
    },
    profilePopout: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض أول اسم متاح في تنسيق الاسم المخصص في نوافذ الملف الشخصي المنبثقة.",
    },
    voiceChannels: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض أول اسم متاح في تنسيق الاسم المخصص في القنوات الصوتية.",
    },
    reactions: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "عرض أول اسم متاح في تنسيق الاسم المخصص في تلميحات ردود الفعل والاسم الكامل في نوافذ ردود الفعل المنبثقة.",
    },
    discriminators: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "إلحاق المُعرِّفات بأسماء مستخدمي البوتات. لم تعد المُعرِّفات مستخدمة للمستخدمين، لكنها لا تزال مستخدمة للبوتات. بشكل افتراضي، يساوي اسم مستخدم البوت الاسم العالمي للمستخدم، لذا يمكن لعدة بوتات أن تتشارك الاسم ذاته. إلحاق المُعرِّفات يجعلها فريدة من جديد.",
    },
    hideDefaultAtSign: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "إخفاء رمز \"@\" الافتراضي قبل الاسم في الإشارات والردود. يُطبَّق فقط إذا كانت إحدى الميزتين مفعّلة.",
    },
    truncateAllNamesWithStreamerMode: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "اقتصاص جميع الأسماء وليس أسماء المستخدمين فقط في وضع البث.",
    },
    removeDuplicates: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "إذا كانت أي أسماء متطابقة، فتُحذف تاركةً فقط الأسماء الفريدة.",
    },
    ignoreFonts: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "استخدام الخطوط الافتراضية لـ Discord للأسماء غير الأساسية بصرف النظر عن خط النيترو المخصص للمستخدم.",
    },
    ignoreGradients: {
        type: OptionType.BOOLEAN,
        default: true,
        description: "للأسماء غير الأساسية، إذا كان للدور تدرج لوني والإعداد أدناه مضبوطاً على \"Role+-#\"، يُستخدم اللون الأساسي بدلاً من التدرج الكامل، وإذا كان له تأثير نيترو فيُتجاهل كلياً."
    },
    animateGradients: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "للأسماء غير الأساسية، إذا كان للدور تدرج لوني أو تأثير نيترو فيُحرَّك. يُعطَّل هذا بواسطة \"تجاهل التدرجات\" والحركة المخففة.",
    },
    nameSeparator: {
        type: OptionType.STRING,
        description: "الفاصل المستخدم بين الأسماء. الافتراضي هو مسافة واحدة.",
        default: " ",
    },
    friendNameOnlyInDirectMessages: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "عرض أسماء الأصدقاء فقط في الرسائل المباشرة وليس في الخوادم.",
    },
    customNameOnlyInDirectMessages: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "عرض الأسماء المخصصة فقط في الرسائل المباشرة وليس في الخوادم.",
    },
    alwaysShowEffects: {
        type: OptionType.BOOLEAN,
        default: false,
        description: "إظهار التأثيرات دائماً كما لو كنت تحوم بالمؤشر.",
    },
    includedNames: {
        type: OptionType.STRING,
        description: "ترتيب عرض أسماء المستخدمين وأسماء العرض والألقاب وأسماء الأصدقاء والأسماء المخصصة. استخدم العناصر النائبة التالية: {user}، {display}، {nick}، {friend}، {custom}. يمكنك تقديم خيارات أسماء متعددة كبدائل إذا لم يكن أحدها متاحاً بفصلها بفواصل هكذا: {custom, friend, nick}. يمكن أن يكون لكل اسم ما يصل إلى ثلاثة بادئات وثلاثة لاحقات.",
        default: "{custom, friend, nick} [{display}] (@{user})",
        isValid: validTemplate,
    },
    customNameColor: {
        type: OptionType.STRING,
        description: "اللون المستخدم للاسم المخصص الذي عيّنته للمستخدم إذا لم يكن أول اسم معروض. يقبل أي مدخل CSS صالح. استخدم \"Role\" لمتابعة ألوان أعلى دور للمستخدم أو ألوان تأثير نيترو أو لون IRCColors إذا كان مفعّلاً. استخدم \"Role+-#\" لضبط السطوع بهذه النسبة (مثال: \"Role+15\")",
        default: "Role-25",
        isValid: validColor,
    },
    friendNameColor: {
        type: OptionType.STRING,
        description: "اللون المستخدم للقب اسم الصديق إذا لم يكن أول اسم معروض. يقبل أي مدخل CSS صالح. استخدم \"Role\" لمتابعة ألوان أعلى دور للمستخدم أو ألوان تأثير نيترو أو لون IRCColors إذا كان مفعّلاً. استخدم \"Role+-#\" لضبط السطوع بهذه النسبة (مثال: \"Role+15\")",
        default: "Role-25",
        isValid: validColor,
    },
    nicknameColor: {
        type: OptionType.STRING,
        description: "اللون المستخدم للقب إذا لم يكن أول اسم معروض. يقبل أي مدخل CSS صالح. استخدم \"Role\" لمتابعة ألوان أعلى دور للمستخدم أو ألوان تأثير نيترو أو لون IRCColors إذا كان مفعّلاً. استخدم \"Role+-#\" لضبط السطوع بهذه النسبة (مثال: \"Role+15\")",
        default: "Role-25",
        isValid: validColor,
    },
    displayNameColor: {
        type: OptionType.STRING,
        description: "اللون المستخدم لاسم العرض إذا لم يكن أول اسم معروض. يقبل أي مدخل CSS صالح. استخدم \"Role\" لمتابعة ألوان أعلى دور للمستخدم أو ألوان تأثير نيترو أو لون IRCColors إذا كان مفعّلاً. استخدم \"Role+-#\" لضبط السطوع بهذه النسبة (مثال: \"Role+15\")",
        default: "Role-25",
        isValid: validColor,
    },
    usernameColor: {
        type: OptionType.STRING,
        description: "اللون المستخدم لاسم المستخدم إذا لم يكن أول اسم معروض. يقبل أي مدخل CSS صالح. استخدم \"Role\" لمتابعة ألوان أعلى دور للمستخدم أو ألوان تأثير نيترو أو لون IRCColors إذا كان مفعّلاً. استخدم \"Role+-#\" لضبط السطوع بهذه النسبة (مثال: \"Role+15\")",
        default: "Role-25",
        isValid: validColor,
    },
    triggerNameRerender: {
        type: OptionType.BOOLEAN,
        description: "تشغيل إعادة رسم الأسماء عبر تبديل هذا الإعداد.",
        default: false,
        hidden: true
    },
});
