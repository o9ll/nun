...
export default class Tooltip {
    ...
    constructor(node: HTMLElement, text: string | HTMLElement, options: TooltipOptions = {}) {
        ...
        this.element = DOMManager.parseHTML(`<div class="nu-layer">`) as HTMLDivElement;
        this.tooltipElement = DOMManager.parseHTML(`<div class="nu-tooltip"><div class="nu-tooltip-pointer"></div><div class="nu-tooltip-content"></div></div>`) as HTMLDivElement;
        this.tooltipElement.classList.add(`nu-tooltip-${this.style}`);
    ...
    showAbove() {
        this.tooltipElement.classList.add("nu-tooltip-top");
    ...
    showBelow() {
        this.tooltipElement.classList.add("nu-tooltip-bottom");
    ...
    showLeft() {
        this.tooltipElement.classList.add("nu-tooltip-left");
    ...
    showRight() {
        this.tooltipElement.classList.add("nu-tooltip-right");
