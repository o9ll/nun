...
import type { Rules, SimpleMarkdown } from "../../types/modules";
...
export default function Markdown({ className, children }: PropsWithChildren<{ className?: string; }>) {
    ...
    if (!DiscordMarkdown) return <div className="markdown-fallback">{children}</div>;
