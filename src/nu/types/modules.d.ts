...
export type Rule = {
    ...
    react?: (e: Record<string, any>, t: (s: string, o: object) => string, n: object) => React.ReactElement;
...
export interface SimpleMarkdown {
    ...
    reactFor: (o: object) => (o2: object) => React.ReactElement;
}