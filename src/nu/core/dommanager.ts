...
export default class DOMManager {
    static init() {
        DOMManager.createElement("nu-head", { target: document.body });
        DOMManager.createElement("nu-body", { target: document.body });
        DOMManager.createElement("nu-scripts", { target: DOMManager.nuHead });
        DOMManager.createElement("nu-styles", { target: DOMManager.nuHead });
        DOMManager.createElement("nu-themes", { target: DOMManager.nuHead });
        DOMManager.createElement("style", { id: "customcss", target: DOMManager.nuHead });
    }
    ...
    static get nuHead() { return this.getElement("nu-head")!; }
    static get nuBody() { return this.getElement("nu-body")!; }
    static get nuScripts() { return this.getElement("nu-scripts")!; }
    static get nuStyles() { return this.getElement("nu-styles")!; }
    static get nuThemes() { return this.getElement("nu-themes")!; }
    static get nuCustomCSS() { return this.getElement("style#customcss")!; }
    // static get nuTooltips() {return this.getElement("nu-tooltips") || this.createElement("nu-tooltips").appendTo(this.nuBody);}
    // static get nuModals() {return this.getElement("nu-modals") || this.createElement("nu-modals").appendTo(this.nuBody);}
    // static get nuToasts() {return this.getElement("nu-toasts") || this.createElement("nu-toasts").appendTo(this.nuBody);}

    static initialize() {
        // this.createElement("nu-head", {target: document.head});
        // this.createElement("nu-body", {target: document.body});
        // this.createElement("nu-scripts", {target: this.nuHead});
        // this.createElement("nu-styles", {target: this.nuHead});
        // this.createElement("nu-themes", {target: this.nuHead});
        // this.createElement("style", {id: "customcss", target: this.nuHead});
    }
    ...
    */
    ...
    static removeStyle(id: string) {
        id = this.escapeID(id);
        const exists = this.getElement(`#${id}`, this.nuStyles);
        if (exists) exists.remove();
    }

    static injectStyle(id: string, css: string) {
        id = this.escapeID(id);
        const style = this.getElement(`#${id}`, this.nuStyles) || this.createElement("style", { id });
        style.textContent = css;
        this.nuStyles.append(style);
    }
    ...
    static linkStyle(id: string, url: string, { documentHead = false } = {}) {
        ...
        return new Promise(resolve => {
            const link: HTMLLinkElement = this.getElement(`#${id}`, this.nuStyles) as HTMLLinkElement || this.createElement("link", { id });
            link.rel = "stylesheet";
            link.href = url;
            link.onload = resolve;
            const target = documentHead ? document.head : this.nuStyles;
            target.append(link);
        });
    }
    ...
    static injectTheme(id: string, css: string) {
        ...
        style.textContent = css;
        this.nuThemes.append(style);
    }

    static updateCustomCSS(css: string) {
        this.nuCustomCSS.textContent = css;
    }

    static removeScript(id: string) {
        id = this.escapeID(id);
        const exists = this.getElement(`#${id}`, this.nuScripts);
        if (exists) exists.remove();
    }
    ...
    static injectScript(id: string, url: string) {
        ...
        return new Promise((resolve, reject) => {
            const script: HTMLScriptElement = this.getElement(`#${id}`, this.nuScripts) as HTMLScriptElement || this.createElement("script", { id });
            script.src = url;
            script.onload = resolve;
            script.onerror = reject;
            this.nuScripts.append(script);
        });
    }
